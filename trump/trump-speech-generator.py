...
path = "data/trump_input.txt"
char_idx_file = 'data/char_idx.pickle'

if not os.path.isfile(path):
    urllib.request.urlretrieve("https://s3-ap-southeast-2.amazonaws.com/tf-training-data/trump_input.txt", path)
...
m = tflearn.SequenceGenerator(g, dictionary=char_idx,
                              seq_maxlen=maxlen,
                              clip_gradients=5.0,
                              checkpoint_path='data/model_trump')
